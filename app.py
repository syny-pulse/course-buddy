...
# Vercel's Python builder uses AST parsing to find the app variable.
# It must be a top-level assignment.
app = Flask(__name__, instance_path='/tmp/instance' if is_vercel else None)
...
app.config['SQLALCHEMY_DATABASE_URI'] = db_url or ('sqlite:////tmp/coursework.db' if is_vercel else 'sqlite:///coursework.db')
